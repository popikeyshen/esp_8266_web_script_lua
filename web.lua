...
wifi.sta.config("PaulVanCannoby","independenceofukraine1999")
...
srv:listen(80, function(conn)
    conn:on("receive", function(client, request)
        ...
        buf = "<p>GPIO00 <a href=\"?GPIO00=1\"><button>ON</button></a><a href=\"?GPIO00=0\"><button>OFF</button></a></p>";
        buf = buf.."<p>GPIO01 <a href=\"?GPIO01=1\"><button>ON</button></a><a href=\"?GPIO01=0\"><button>OFF</button></a></p>";
        buf = buf.."<p>Диод <a href=\"?GPIO02=1\"><button>ON</button></a><a href=\"?GPIO02=0\"><button>OFF</button></a></p>";
